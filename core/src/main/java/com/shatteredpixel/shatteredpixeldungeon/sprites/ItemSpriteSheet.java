...
public class ItemSpriteSheet {
	...
	static{
        ...
        assignItemRect(SMALL_BOMB,  14, 13);
	}
    ...
    public static final int THROWING_DISK   = MISSILE_WEP+8;
	static{
        ...
        assignItemRect(SERRATED_DART,   15, 15);
        assignItemRect(THROWING_DISK,   16, 16);
	}
    ...
    static{
        ...
        assignItemRect(ARMOR_HALF,      14, 12);
        assignItemRect(ARMOR_PLATE,     12, 12);
        assignItemRect(ARMOR_MITHRIL,   12, 12);
        assignItemRect(ARMOR_TUNIC,     14, 13);
        assignItemRect(ARMOR_LETHER,    15, 13);
        assignItemRect(ARMOR_SCALE_MAIL,14, 13);
        assignItemRect(ARMOR_SCALE,     14, 14);
	...
	static{
        ...
        assignItemRect(ARTIFACT_SIGIL,      16, 16);
        assignItemRect(ARTIFACT_BOMB,       15, 15);
	}
    ...
    public static final int POTION_SCARLET  = POTIONS+12;
	static {
    ...
    public static final int MUSHROOM    = FOOD+10;
	static{
